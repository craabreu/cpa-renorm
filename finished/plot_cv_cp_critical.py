...
ax[0].plot(P, cv, 's', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Tr = 1.0')
...
ax[1].plot(Pp, cp, 's', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Tr = 1.0')
...
ax.plot(P, cv, 's', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Tr = 0.9')
...
#ax[1].set_aspect(aspect='auto', adjustable='box')
ax.tick_params(direction='in')
ax.plot(Pp, cp, 's', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Tr = 0.9')
