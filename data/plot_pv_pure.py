...
ax[0,0].text(18500, 515, r'$\rm Methanol$',size=22)
...
ax[1,0].text(23000, 305, r'$\rm CO_{2}$',size=22)
...
ax[0,1].text(25500, 375, r'$\rm H_{2}S$',size=22)
...
ax[1,1].set_xlim([-500,13000])
ax[1,1].set_ylim([150,450])
ax[1,1].set_xticks(np.arange(0,13000,2500))
ax[1,1].text(9500, 415, r'$\rm n-Butane$',size=22)
