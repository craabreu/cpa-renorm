...
\pdfcomment[author=Charlles]{Seria conveniente dizer qual é a simplificação em relação à CPA original}
...
The recursive method developed by White and Zhang \cite{white1993renormalization, white1995renormalization, white1998renormalization} and by Salvino and White \citep{salvino1992calculation} introduces density fluctuations to \hl{a given framework} of Helmholtz energy density.
\pdfcomment[author=Charlles]{A expressão "a given framework" é vaga. Deveríamos trocá-la por uma expressão mais precisa.}
...
\pdfcomment[author=Charlles]{Aqui não está claro o que r significa exatamente. Isso também tem implicações em outras equações a seguir.}
...
\end{equation}
\pdfcomment[author=Charlles]{Mais uma vez, a coordenada r não está devidamente identificada.}
