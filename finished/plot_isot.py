...
plt.plot(rho0, P0, 'o', markerfacecolor='none', markeredgecolor='black', label='512.60 K')
plt.plot(rho1, P1, 's', markerfacecolor='none', markeredgecolor='black', label='563.86 K')
