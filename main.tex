...
To note, in this work we used the derivation provided by White and co-workers \cite{white1993renormalization,white1995renormalization,white1998renormalization}, and applied successfully by other authors for cubic-EoS \cite{cai2006vapor,pcm2017application,xu2010crossover,xu2011prediction}
...
\multirow{2}{*}{Substance} & \multicolumn{2}{c}{$\displaystyle \left(\frac{T_{c}-T_{c}^\text{exp}}{T_{c}^\text{exp}}\right)$} & \multicolumn{2}{c}{$\displaystyle \left(\frac{P_{c}-P_{c}^\text{exp}}{P_{c}^\text{exp}}\right)$} & \multicolumn{2}{c}{$\displaystyle \left(\frac{\rho_{c}-\rho_{c}^\text{exp}}{\rho_{c}^\text{exp}}\right)$} &  \\ \cline{2-7}
   & CPA& CPA+RG  & CPA   & CPA+RG& CPA & CPA+RG   &  \\ \hline
n-Butane   & 1.49   & 0.85& 13.54 & 6.32  & 8.01& 7.14 &  \\
Methanol   & 4.49   & -0.12& 32.68 & 1.23  & 5.17& -2.28 &  \\
