...
ax.plot(x303, P303, 's', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Methanol')
ax.plot(x328, P328, 'o', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Methanol')
...
ax.set_xlim([0,1])
ax.set_ylim([2,10])
ax.text(0.2, 9, '$k_{ij}=0$', color='red', fontsize=16)
