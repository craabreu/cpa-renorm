...
ax[0].plot(P, cv8, 'o', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Tr = 0.8')
ax[0].plot(P, cv9, 's', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Tr = 0.9')
...
ax[1].plot(Pp, cp8, 'o', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Tr = 0.8')
ax[1].plot(Pp, cp9, 's', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Tr = 0.9')
...
ax.plot(P, cv8, 'o', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Tr = 0.8')
ax.plot(P, cv9, 's', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Tr = 0.9')
...
#ax[1].set_aspect(aspect='auto', adjustable='box')
ax.tick_params(direction='in')
ax.plot(Pp, cp8, 'o', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Tr = 0.8')
ax.plot(Pp, cp9, 's', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Tr = 0.9')
