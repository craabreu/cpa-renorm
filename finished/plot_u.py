...
ax[0].plot(P, u8, 'o', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Tr = 0.8')
ax[0].plot(P, u9, 's', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Tr = 0.9')
...
ax[1].plot(P10, u10, 's', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Tr = 0.9')
...
ax[2].plot(P10, u11, 'o', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Tr = 0.8')
ax[2].plot(P10, u12, 's', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Tr = 0.9')
...
ax[2].set_xlabel(x1label)
ax[2].set_ylabel(y1label)
...
ax.plot(P, u8, 'o', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Tr = 0.8')
ax.plot(P, u9, 's', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Tr = 0.9')
...
#ax[1].set_aspect(aspect='auto', adjustable='box')
ax.tick_params(direction='in')
ax.plot(P10, u10, 's', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Tr = 0.9')
...
#ax[1].set_aspect(aspect='auto', adjustable='box')
ax.tick_params(direction='in')
ax.plot(P10, u11, 'o', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Tr = 0.8')
ax.plot(P10, u12, 's', markerfacecolor='none', markeredgecolor='black', markersize=5, label='Tr = 0.9')
